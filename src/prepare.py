...
class Prepare(zntrack.Node):
    split: float = zntrack.zn.params(0.20)
    seed: int = zntrack.zn.params(20170428)

    data: str = zntrack.dvc.deps("data/data.xml")
    outs: str = zntrack.dvc.outs("data/prepared")
